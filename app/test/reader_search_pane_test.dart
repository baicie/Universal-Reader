...
void main() {
  testWidgets(
    'ReaderSearchPane renders title, hint and field with empty state',
    (tester) async {
  ...
  testWidgets(
    ...
    'when the parent updates the query',
    (tester) async {
      ...
      final newController = tester
          ...
          .controller!;
      expect(
        identical(newController, initialController),
        isTrue,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        sameController.selection.baseOffset,
        4,
  ...
  testWidgets('ReaderSearchPane snaps the cursor to the end when the parent '
