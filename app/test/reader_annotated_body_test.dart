...
void main() {
  ...
  testWidgets('omits the gap widget when there is only one paragraph',
    ...
    await tester.pumpAndSettle();
    expect(
      find.byWidgetPredicate((w) => identical(w, gap)),
      findsNothing,
    );
  });
  ...
  testWidgets(
    'ignores bookmarks when locating the highlighted quote',
    (tester) async {
  ...
  testWidgets(
    'annotatePlainText splits text around the matched quote',
    (tester) async {
  ...
  testWidgets(
    'annotatePlainText highlights every occurrence of the quote',
    (tester) async {
  ...
  testWidgets(
    'annotatePlainText with empty text returns one empty span',
    (tester) async {
      final spans = annotatePlainText('', [
        ReaderAnnotation(
          id: 'a',
  ...
  testWidgets(
    'quoteHighlights excludes bookmark sources and blank quotes',
    (tester) async {
