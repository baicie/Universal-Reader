...
void main() {
  Widget wrap(Widget child) {
    return MaterialApp(
      ...
      home: Scaffold(body: SizedBox(height: 800, width: 240, child: child)),
    );
  }
  ...
  testWidgets('renders nothing relevant when every toggle is off', (
    tester,
  ) async {
  ...
  testWidgets('renders only the search pane when showSearch is on', (
    tester,
  ) async {
    await tester.pumpWidget(
      wrap(
